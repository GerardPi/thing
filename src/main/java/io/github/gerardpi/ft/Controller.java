...
import io.github.gerardpi.ft.editor.EditorContext;
import io.github.gerardpi.ft.logging.TextAreaLogAppender;
import io.github.gerardpi.ft.navigator.NavigatorContext;
...
public class Controller implements EventHandler<KeyEvent> {
    ...
    private static void bindCommandInputFocusChange(View view, Controller controller) {
        view.getCommandInput().focusedProperty()
                .addListener((observable, oldValue, newValue) -> controller.commandInputFocusChanged(oldValue, newValue));
    }
    ...
    void addNewEditorPane() {
        ...
        io.github.gerardpi.ft.editor.Controller controller = new io.github.gerardpi.ft.editor.Controller(editorContext);
        addContentTab(controller);
    }

    public void addNewFileNavigatorPane() {
        NavigatorContext context = new NavigatorContext(Paths.get("/"));
        io.github.gerardpi.ft.navigator.Controller controller = new io.github.gerardpi.ft.navigator.Controller(context);
        addContentTab(controller);
